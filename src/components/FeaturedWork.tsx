  ...
  const projects = [
    {
      ...
      thumbnail: "https://images.pexels.com/photos/1117132/pexels-photo-1117132.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      link: "/portfolio/cinematic-film-trailer"
    },
    {
      id: 2,
      title: t('featuredWork.projects.teaser.title'),
      category: t('featuredWork.projects.teaser.category'),
      thumbnail: "https://images.pexels.com/photos/4007744/pexels-photo-4007744.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      link: "/portfolio/product-launch-teaser"
    },
    {
      id: 3,
      ...
      link: "/portfolio/summer-collection-billboard"
    },
    {
      id: 4,
      title: t('featuredWork.projects.corporate.title'),
      category: t('featuredWork.projects.corporate.category'),
      thumbnail: "https://images.pexels.com/photos/1616779/pexels-photo-1616779.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      link: "/portfolio/corporate-brand-story"
    }
  ];
            ...
            >
              <div className="aspect-w-16 aspect-h-9 relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-dark/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-6 text-white">
                  ...
                  <h3 className="text-xl font-next-art mb-4 text-center">{project.title}</h3>
                  <Link 
                    to={project.link} 
                    className="flex items-center text-tertiary hover:text-white transition-colors"
                  >
                    {t('featuredWork.viewAll')} <ExternalLink size={16} className="ml-1" />
                  </Link>
                </div>
              </div>
            </motion.div>
